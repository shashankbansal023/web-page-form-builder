...
const Designer = () => {
    ...
    useDndMonitor({
        onDragEnd: (event: DragEndEvent) => {
            ...
            // first scenario - droping over the designer drop area;
            ...
            if(droppingSidebarBtnOverDesignerElement){
                ...
                const indexForNewElement = isDroppingOverDesignerElementBottomHalf ? overElementIndex +1 : overElementIndex;
